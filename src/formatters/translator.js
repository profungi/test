...
2. 描述：这是最重要的部分！你必须从详细描述中提取具体信息。
   ...
   【字数要求】
   - 20-35字，信息密度要高
   - 如果需要更多字数才能表达清楚，可以到40字

   【优秀示例 - 信息丰富且有吸引力】
   ✅ "20多个本地艺术家摊位，绘画雕塑和手工艺品，适合拍照打卡"
      （具体内容 + 数字 + 用户喜好）

   ✅ "印度舞蹈和音乐表演，南亚美食摊位，湾区知名的Diwali庆典"
      （具体表演 + 食物 + 活动影响力）

   ✅ "服装比赛、放映《圣诞夜惊魂》、互动游戏，家庭友好"
      （特色活动 + 具体电影 + 用户喜好）

   ✅ "壁画导览、TED演讲、才艺秀、瑜伽和声浴，遛娃好去处"
      （多项活动 + 用户喜好）

   ✅ "本地餐厅BBQ烧烤、精酿啤酒试饮、现场乐队，湾区年度美食盛会"
      （食物 + 饮品 + 娱乐 + 影响力）
   ...
   【创作流程】
   第一步：仔细阅读详细描述，找出所有具体信息
   第二步：提取具体内容（食物/表演/艺术类型、特色活动）
   第三步：判断用户喜好（家庭友好？拍照打卡？遛娃？）
   第四步：识别活动影响力（年度盛事？湾区知名？社区传统？）
   第五步：组织成20-40字的描述，信息密度高且有吸引力

   重要：即使描述简单，也必须从中提取信息，禁止使用"活动详情查看链接"
...
2. description_cn - 必须20-40字，从详细描述提取具体信息，加入用户喜好和影响力

   创作原则：
   a) 组合2-3项信息（具体内容 + 用户喜好/影响力）
   b) 严禁空泛词："感受氛围""体验""各种""众多"
   c) 严禁："活动详情查看链接"
   d) 不要提及：时间、地点、价格
   ...
   - "壁画导览、TED演讲、才艺秀、瑜伽声浴，家庭友好适合遛娃"
     ✅ 多项活动 + 用户喜好

   - "20多个艺术家摊位，绘画雕塑和手工艺品，适合拍照打卡"
     ✅ 数字 + 具体内容 + 用户喜好

   - "服装比赛、放映《圣诞夜惊魂》、互动游戏，全家都能玩"
     ✅ 特色活动 + 用户喜好
...
输出:
  description_cn: "20多个本地艺术家和wellness practitioners，绘画雕塑和手工艺品摊位"
  ✅ 提取了数字、人员类型、商品类型
...
完整示例3（信息很少）:
输入:
  标题: "Community Gathering"
  详细描述: "Join us for a wonderful community event!"

输出:
  description_cn: "活动详情查看链接"
  ✅ 描述太空，诚实告知无法提取信息`;
  }
