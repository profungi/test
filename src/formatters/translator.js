...
2. 描述：这是最重要的部分！你必须从详细描述中提取具体信息。
   ...
   - "各种..." "众多..." "一些..." "很多..."
   - "精彩" "丰富" "有趣" "好玩"
   - "社区活动" "本地活动" "社区庆祝" （太笼统，必须说具体做什么）
   - "美食、音乐和娱乐" （太空泛，必须具体说什么美食/音乐/娱乐）
   - 活动类型词（"节日"、"市集"、"之夜"不要出现在描述里）
   ...
   【错误示例 - 必须避免】
   ❌ "社区活动"
      问题：太空泛！必须说具体内容（如：义卖、音乐会、工作坊）

   ❌ "美食、音乐和娱乐活动"
      问题：太笼统！必须说什么美食/音乐/娱乐

   ❌ "手工艺品和农场新鲜产品"（重复使用模板）
      问题：必须从description提取具体信息，不要用模板

   ❌ "有艺术作品展和市集摊位"
      问题：说了等于没说，要说什么类型的艺术/摊位
   ...
   【强制要求】
   ✅ 每条描述必须包含至少2个具体信息点
   ✅ 必须从description中提取真实内容，不要编造
   ✅ 禁止重复使用相同的模板描述
   ✅ 至少30%的描述要加入种草话术（值得一去、别错过等）

   【严禁事项】
   ❌ 禁用词："社区活动"、"本地活动"、"美食音乐娱乐"
   ❌ 不要提地点（"在XX举办"、"来XX参加"）
   ❌ 不要提时间/价格（除非用于种草如"免费入场"）
   ❌ 不要用空话："感受""体验""探索""氛围""各种""众多"
   ❌ 不要重复用模板："手工艺品和农场新鲜产品"
   ❌ 不要用类型词："节日"、"市集"、"之夜"（已在标题）
...
2. 严禁使用空泛词汇和模板：
   ❌ "社区活动" "本地活动" "美食音乐娱乐"（太笼统！）
   ❌ "感受氛围" "体验" "探索" "发现"
   ❌ "各种" "众多" "一些" "很多"
   ❌ "手工艺品和农场新鲜产品"（不要重复用同一个模板！）
   ❌ "活动详情查看链接"（禁止使用！）

3. 强制要求：
   ✅ 每条描述至少包含2个具体信息点
   ✅ 必须从description提取真实内容
   ✅ 不要重复：时间、地点、价格（除非种草如"免费入场"）
   ✅ 至少30%的描述要有种草话术
...
2. description_cn - 必须20-40字，从详细描述提取具体信息，适度加入种草话术
   ...
   ⚠️  严格创作原则：
   a) 必须包含至少2个具体信息点（不能只说"社区活动"！）
   b) 必须从description提取真实内容，不要编造或用模板
   c) 严禁使用："社区活动"、"本地活动"、"美食音乐娱乐"
   d) 严禁重复用模板："手工艺品和农场新鲜产品"
   e) 每2-3条添加种草话术：值得一去、别错过、超赞、免费入场
   f) 不要提及：时间、地点（除非种草）、活动类型词（节日/市集/之夜）
