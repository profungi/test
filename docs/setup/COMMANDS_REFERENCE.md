...
### 5. 测试手动添加活动 - `node test-manual-add.js` (v1.7 新功能)

**功能**：测试手动添加活动功能（从任意URL抓取活动信息）

```bash
# 测试3个已知scraper网站
node test-manual-add.js

# 测试自定义URL（支持任意网站，使用AI提取）
...
📝 测试: Eventbrite - French Holiday Market
...
✅ 抓取成功！
   ...
   URL: https://www.eventbrite.com/e/french-holiday-market-tickets-1902205561039
   手动添加标记: true
   来源网站: https://www.eventbrite.com/e/french-holiday-market-tickets-1902205561039
